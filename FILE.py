...
def linex():
	os.system('echo  "\n Use Airoplane Mode\n" | lolcat -a -d 2 -s 50')
def logo():
	os.system('echo "\n########  ######## ##     ## ##     ##    ###    ##    ##\n##     ## ##       ##     ## ###   ###   ## ##   ###   ##\n##     ## ##       ##     ## #### ####  ##   ##  ####  ##\n########  ######   ######### ## ### ## ##     ## ## ## ##\n##   ##   ##       ##     ## ##     ## ######### ##  ####\n##    ##  ##       ##     ## ##     ## ##     ## ##   ###\n##     ## ######## ##     ## ##     ## ##     ## ##    ## \nTEAM√ : RED-MAFIA(RK)\nFUCK  : YAR GF NAHI HAI\n" | lolcat -a -d 2 -s 50')	
def logo1():"AAA"
def main():
	os.system("clear")
	logo()
	print("===================================")
	print("Author : RIAZKHAN(RK)")
	print("GitHub : RED-MAFIA-RK")
	print("FACEB : RIAZKHAN(RK)")
	print("===================================")
	print("")
...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/Red-Mafia-FAST-FILE.git")
			os.system("rm -rf FILE.py")
			os.system("cp -f FAST-FILE/FILE.py \\.")
			os.system("rm -rf FILE.py")
			print "\033[92;1m\n Thanks Updating...>_<\n"
			time.sleep(2)
			main()
		except KeyboardInterrupt:
			print "\033[91;1m\n YOUR DEVICE KAM KA NAHI !\n"
	        	main()
	elif sel =="0" or sel =="00":
		xox("\n\t\033[91;1m GOOD BYE SEE YOU AGAIN RED-MAFIA :)")
		sys.exit()
	else:
		print("")
...
def menu():
    ...
    logo()
    print("============================")
    print("TEAM√ : RED-MAFIA(RK)")
    print("FUCK  : YAR GF NAHI HAI")
    print("=============================")
    print("\033[93;1m     AGAYE : \033[92;1m"+xn)
    print("\033[93;1m     Region : \033[92;1m") + loc
    print("\033[93;1m     Ip : \033[92;1m") + ip
    print("=============================")

    print("=============================")
    print("\033[92;1m[1] Start KAR ")
